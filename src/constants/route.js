...
export const ROUTE = {
  home: {
    ...
    to: '/',
    icon: <HomeIcon />,
    news: { title: 'News', to: '/#news' },
    video: { title: 'Video', to: '/#video', icon: <YouTubeIcon /> },
    social: { title: 'Social', to: '/#social' },
  },
  about: { title: 'About', to: '/about', icon: <AnnouncementOutlinedIcon /> },
